...
function filtrar(){
   ...
   let mostrar= array.filter(dato => dato.destino == "Canarias-" || dato.destino == "Mallorca-" || dato.destino == "Galicia-");

   let stringMostrar = "";

   for (let datos of mostrar){
    console.log(datos.nombre);
    stringMostrar += ` Nombre: ${datos.nombre}
                       Destino:${datos.destino} `
}
console.log(stringMostrar);
document.getElementById("Texto6").append(stringMostrar )  
